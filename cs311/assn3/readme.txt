...
Things to turn in:
C/C++ source code for the solution to the posed problem.
A makefile to build your code and your write-up
A postscript file containing your timings plot.
Your write-up, which contains the same content as necessary in Assignment 2.
