...
You will be writing 2 slightly different versions of this project
	A threaded version with implicit sharing
	A version using multiple processes and shared memory
...
Things to turn in:
C/C++ source code for the solutions to the posed problem.
A makefile to build your code
A writeup of your project, including work log, as described above.
